...
**DClaw Lease** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8057` (FastAPI)
- **Frontend Port:** `3057` (Next.js)
- **Database:** `dclaw_lease` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3057`
